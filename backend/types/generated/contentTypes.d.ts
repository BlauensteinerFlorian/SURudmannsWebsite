...
export interface ApiTeampictureTeampicture extends Struct.SingleTypeSchema {
  collectionName: 'teampictures';
  info: {
    displayName: 'teampicture';
    pluralName: 'teampictures';
    singularName: 'teampicture';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::teampicture.teampicture': ApiTeampictureTeampicture;
