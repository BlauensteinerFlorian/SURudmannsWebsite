            ...
            <div className="grid md:grid-cols-3 gap-10">
              ...
              <div>
                ...
                <div className="flex flex-col gap-2">
                  <a href="https://instagram.com/surudmanns" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:underline">
                  ...
                  <a href="https://facebook.com/SURudmanns" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:underline">
